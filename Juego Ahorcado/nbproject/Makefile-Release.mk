...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_ahorcado.exe
...
${OBJECTDIR}/Arreglo_Palabra.o: Arreglo_Palabra.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arreglo_Palabra.o Arreglo_Palabra.cpp

${OBJECTDIR}/Interfaz_Grafica.o: Interfaz_Grafica.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Interfaz_Grafica.o Interfaz_Grafica.cpp
